...
hoistedDependencies:
  ...
  /cosmiconfig/8.3.6(typescript@5.7.2):
    cosmiconfig: private
  /create-jest/29.7.0(@types/node@20.17.10)(ts-node@10.9.2):
    create-jest: private
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@20.17.10)(ts-node@10.9.2):
    jest-cli: private
  /jest-config/29.7.0(@types/node@20.17.10)(ts-node@10.9.2):
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Sat, 14 Dec 2024 07:16:42 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
